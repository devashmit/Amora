              ...
              <div className="lg:col-span-5 space-y-8 text-left">
                <div className="space-y-4">
                  <h1 className="font-heading text-4xl md:text-[3.5rem] font-light leading-[1.15] tracking-tight text-[#0C231C] text-balance">
                    Letters that wait to be opened.
                  </h1>
                  <p className="text-base text-[#0C231C]/75 font-light tracking-wide max-w-md">
                    Amora is a sanctuary for slow digital correspondence. Write meaningful letters, seal them inside a beautiful digital envelope, and send them as private keepsakes.
                  </p>
                </div>
